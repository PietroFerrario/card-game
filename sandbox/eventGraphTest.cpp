#include "game_system/eventGraph.h"
...
#include "ui/terminalProgressionView.h"
...
int main()
{
    ...
    TerminalProgressionView TerminalProgressionView{io};
    ...
    EventGraph eventGraph{gameConfig,         terminalMatchView,
                          terminalRewardView, TerminalProgressionView,
                          cardFactory,        mainPlayer};
    eventGraph.resolveEvents();
